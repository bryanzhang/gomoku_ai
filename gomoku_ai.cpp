...
PYBIND11_MODULE(gomoku_ai, m) {
    ...
    py::class_<gomoku_ai::PureMCTSGame<8>>(m, "PureMCTSGame8")
        ...
        .def("SearchBestMove", &gomoku_ai::PureMCTSGame<8>::SearchBestMove, py::arg("simulate_times"), "Monte-Carlo tree search for specified times to search the best move.\n");
    ...
    py::class_<gomoku_ai::PureMCTSGame<9>>(m, "PureMCTSGame9")
        ...
        .def("SearchBestMove", &gomoku_ai::PureMCTSGame<9>::SearchBestMove, py::arg("simulate_times"), "Monte-Carlo tree search for specified times to search the best move.\n");
    ...
    py::class_<gomoku_ai::PureMCTSGame<11>>(m, "PureMCTSGame11")
        ...
        .def("SearchBestMove", &gomoku_ai::PureMCTSGame<11>::SearchBestMove, py::arg("simulate_times"), "Monte-Carlo tree search for specified times to search the best move.\n");
    ...
    py::class_<gomoku_ai::PureMCTSGame<15>>(m, "PureMCTSGame15")
        ...
        .def("SearchBestMove", &gomoku_ai::PureMCTSGame<15>::SearchBestMove, py::arg("simulate_times"), "Monte-Carlo tree search for specified times to search the best move.\n");
}
